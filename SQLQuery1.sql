...
-- loomine tabeli Gender ja Person
create table Gender
(
...
--Täidab tabeli Department ja Employees
...
---Valib unikaalsed väärtused
select distinct Name, DepartmentId from Employees

---summeerib kõige palkade summa
select sum(cast(Salary as int)) from Employees
---Võtab välja miinimumpalga
...
--Lisab Employees uus veerg MiddleName ja LastName, ja täidab neid
alter table Employees
...
---loeb tabelis olevate kirjete arvu
...
-- Kirjutame töötaja nime ja saame tema andmed/dokumendid
